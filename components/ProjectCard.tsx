...
const ProjectCard: FunctionComponent<{
  ...
  return (
    <div>
      ...
      {
        showDetail === id && (
        <div className="absolute top-0 left-0 z-10 grid w-full h-auto p-2 bg-gray-100 rounded-lg md-10 md:grid-cols-2 gap-x-12 text-blac dark:text-white dark:bg-dark-100">
        <motion.div 
          variants={stagger}
          initial="initial"
          animate="animate"
